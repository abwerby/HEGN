# Taken from https://github.com/FlyingGiraffe/vnn/blob/master/models/vn_dgcnn_cls.py
from src.models.vn_layers import VNLinearLeakyReLU, VNMaxPool, VNStdFeature, mean_pool
from torch import nn
import torch
from src.utils.vn_dgcnn import get_graph_feature
...
class VNDGCNN(nn.Module):
    ...
    def forward(self, x):
        ...
        # Up to here we extract the node features
